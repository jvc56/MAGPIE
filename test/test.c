...
static TestEntry on_demand_test_table[] = {
    ...
    {"benchab2v3", test_benchmark_endgame_ab_2v3},
    {"benchab3v4", test_benchmark_endgame_ab_3v4},
    {"benchab4v5", test_benchmark_endgame_ab_4v5},
    {"benchab4v5h", test_benchmark_endgame_ab_4v5h},
    {"stucksurvey", test_stuck_tile_survey},
    {"stuckletters", test_stuck_letter_frequency},
    {"abclean1v2h", test_benchmark_ab_clean_1v2h},
    {"eqvs2ply", test_benchmark_equity_vs_2ply},
    {"eqvs3ply", test_benchmark_equity_vs_3ply},
    {"abclean2v3h", test_benchmark_ab_clean_2v3h},
    {"scorevseq", test_benchmark_score_vs_equity},
    {"scorevs2ply", test_benchmark_score_vs_2ply},
    {"scorevs3ply", test_benchmark_score_vs_3ply},
    {"4plytourney", test_benchmark_4ply_tournament},
    {"stucktourney", test_benchmark_stuck_tournament},
    {"deeptourney", test_benchmark_deep_tournament},
