...
void test_error_cases() {
  ...
  test_single_error_case("lexicon_missing.gcg", config,
  ...
  test_single_error_case("lowercase_tile_placement.gcg", config,
  ...
  test_single_error_case("game_events_overflow.gcg", config,
