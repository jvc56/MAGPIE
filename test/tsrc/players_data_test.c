...
void test_for_data_type(const char **data_names, const char *data_dir,
                        players_data_t players_data_type,
  ...
  for (int i = 0; i < number_of_data_names; i += 2) {
    players_data_set(players_data, players_data_type, data_dir, data_names[i],
                     data_names[i + 1]);
...
void test_players_data() {
  ...
  test_for_data_type(data_names, DEFAULT_DATA_DIR, PLAYERS_DATA_TYPE_KWG,
                     number_of_data_names);
  test_for_data_type(data_names, DEFAULT_DATA_DIR, PLAYERS_DATA_TYPE_KLV,
                     number_of_data_names);
  test_unshared_data();
}
