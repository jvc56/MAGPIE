...
void test_leave_count_hashmap(void) {
  ...
  assert(leave_count_hashmap_get(hm, 1) == UNSET_KEY_OR_VALUE);
  ...
  assert(leave_count_hashmap_get(hm, 1) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, 2) == UNSET_KEY_OR_VALUE);
  ...
  assert(leave_count_hashmap_get(hm, 0) == UNSET_KEY_OR_VALUE);
  ...
  assert(leave_count_hashmap_get(hm, capacity * 7) == 7);
  assert(leave_count_hashmap_get(hm, capacity * 8) == 8);
  assert(leave_count_hashmap_get(hm, capacity * 9) == UNSET_KEY_OR_VALUE);
  ...
  assert(leave_count_hashmap_get(hm, capacity * 4) == 4);
  assert(leave_count_hashmap_get(hm, capacity * 5) == 5);
  assert(leave_count_hashmap_get(hm, capacity * 6) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 7) == 7);
  assert(leave_count_hashmap_get(hm, capacity * 8) == 8);
  assert(leave_count_hashmap_get(hm, capacity * 9) == UNSET_KEY_OR_VALUE);
  ...
  assert(leave_count_hashmap_get(hm, capacity) == 1);
  assert(leave_count_hashmap_get(hm, capacity * 2) == 2);
  assert(leave_count_hashmap_get(hm, capacity * 3) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 4) == 4);
  assert(leave_count_hashmap_get(hm, capacity * 5) == 5);
  assert(leave_count_hashmap_get(hm, capacity * 6) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 7) == 7);
  ...
  assert(leave_count_hashmap_get(hm, capacity * 2) == 2);
  assert(leave_count_hashmap_get(hm, capacity * 3) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 4) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 5) == 5);
  assert(leave_count_hashmap_get(hm, capacity * 6) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 7) == 7);
  assert(leave_count_hashmap_get(hm, capacity * 8) == 8);
  ...
  assert(leave_count_hashmap_get(hm, 0) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity) == 1);
  assert(leave_count_hashmap_get(hm, capacity * 2) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 3) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 4) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 5) == 5);
  assert(leave_count_hashmap_get(hm, capacity * 6) == UNSET_KEY_OR_VALUE);
  ...
  assert(leave_count_hashmap_get(hm, 0) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 2) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 3) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 4) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 5) == 5);
  assert(leave_count_hashmap_get(hm, capacity * 6) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 7) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 8) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 9) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get_num_entries(hm) == 1);
  ...
  assert(leave_count_hashmap_get(hm, capacity * 3) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 4) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 5) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 6) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 7) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 8) == UNSET_KEY_OR_VALUE);
  assert(leave_count_hashmap_get(hm, capacity * 9) == UNSET_KEY_OR_VALUE);
