...
void assert_opening_penalties(Game *game, const char *data_path,
                              const char *layout, const char *rack_string,
                              int score, double equity) {
  load_game_with_test_board(game, data_path, layout);
...
void test_board_layout_correctness(void) {
  ...
  load_game_with_test_board(game, data_path, "0_0_start_coords_15");

  assert_validated_and_generated_moves(game, "QUIZEST", "1A", "QUIZ", 96,
                                       false);

  load_game_with_test_board(game, data_path, "0_14_start_coords_15");
  ...
  load_game_with_test_board(game, data_path, "14_0_start_coords_15");
  ...
  load_game_with_test_board(game, data_path, "14_14_start_coords_15");

  assert_validated_and_generated_moves(game, "PIGGIEI", "15J", "PIGGIE", 36,
                                       false);

  // Test bricks
  load_game_with_test_board(game, data_path, "start_is_bricked_15");
  ...
  load_game_with_test_board(game, data_path, "8D_is_bricked_15");
  ...
  load_game_with_test_board(game, data_path, "8G_and_7H_are_bricked_15");
  ...
  load_game_with_test_board(game, data_path, "5_by_5_bricked_box_15");
  ...
  load_game_with_test_board(game, data_path, "single_row_15");
  ...
  assert_opening_penalties(game, data_path, "standard15", "QUIRKED", 112,
                           112 + OPENING_HOTSPOT_PENALTY);
  assert_opening_penalties(game, data_path, "no_bonus_squares_15", "QUIRKED",
                           71, 71);
  assert_opening_penalties(game, data_path, "no_bonus_squares_15", "EUOUAES",
                           57, 57);
  assert_opening_penalties(game, data_path, "many_opening_hotspots_15",
                           "EUOUAES", 66,
                           66 + ((OPENING_HOTSPOT_PENALTY / 2) * 12));
  assert_opening_penalties(game, data_path, "many_opening_hotspots_vertical_15",
                           "EUOUAES", 66,
                           66 + ((OPENING_HOTSPOT_PENALTY / 2) * 5));

  load_game_with_test_board(game, data_path,
  ...
  load_game_with_test_board(game, data_path, "standard15");
