...
void test_wasm_api() {
  ...
  char *retstr = score_move(VS_ED, GAME_EVENT_TILE_PLACEMENT_MOVE, 5, 6, 0,
  ...
  retstr = score_move(VS_ED, GAME_EVENT_EXCHANGE, 0, 0, 0, (uint8_t[]){17, 23},
  ...
  // Score another play
  retstr = score_move(cgp1, GAME_EVENT_TILE_PLACEMENT_MOVE, 1, 1, 0,
