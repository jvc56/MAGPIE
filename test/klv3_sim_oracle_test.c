...
static void run_nested_corpus_oracle(
    const Config *const klv2_config, const Config *const klv3_config,
...
static void run_corpus_oracle(const Config *const klv2_config,
                              const Config *const klv3_config,
