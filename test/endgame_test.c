...
void test_vs_joey(void) {
  ...
  */
  ...
  test_single_endgame(
      "set -s1 score -s2 score -r1 small -r2 small -threads 1 -eplies 13 -ttfraction 0.25",
      "cgp "
...
void test_pass_first(void) {
  ...
  // an unblockable ZA.
  test_single_endgame(
      "set -s1 score -s2 score -r1 small -r2 small -threads 1 -eplies 8 -ttfraction 0.25",
      "cgp "
...
void test_nonempty_bag(void) {
  ...
  test_single_endgame(
      "set -s1 score -s2 score -r1 small -r2 small -threads 1 -eplies 4 -ttfraction 0.25",
...
void test_very_deep(void) {
  ...
  test_single_endgame(
      "set -s1 score -s2 score -r1 small -r2 small -threads 1 -eplies 25 -ttfraction 0.25",
      "cgp "
...
void test_eldar_v_stick(void) {
  test_single_endgame(
      "set -s1 score -s2 score -r1 small -r2 small -threads 1 -eplies 9 -ttfraction 0.25",
      "cgp "
