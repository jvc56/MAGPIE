...
void test_transposition_table(void) {
  ...
  TTEntryData entry;
  ttentry_data_reset(&entry);
  entry.score = 12;
  entry.flag_and_depth = 128 + 64 + 23;
  transposition_table_store(tt, 9409641586937047728ULL, entry);

  TTEntryData lu_entry = transposition_table_lookup(tt, 9409641586937047728ULL);
  assert(ttentry_data_depth(lu_entry) == 23);
  assert(ttentry_data_flag(lu_entry) == TT_UPPER);
  assert(ttentry_data_score(lu_entry) == 12);
  ...
  // 2**24.
  TTEntryData te = transposition_table_lookup(tt, 9409641586953824944ULL);
  ...
  TTEntryData te2 = transposition_table_lookup(tt, 9409641586937047728ULL + 1);
