...
void test_command_execution() {
  ...
  assert_command_status_and_output(
      command_vars, "go sim lex CSW21 i 1000 plies", false, 5,
  ...
  assert_command_status_and_output(
      ...
      false, 60, ERROR_STATUS_TYPE_NONE, 0, 5);
  ...
  assert_command_status_and_output(
      ...
      false, 60, ERROR_STATUS_TYPE_NONE, 0, 21);
  ...
  assert_command_status_and_output(
      ...
      false, 60, ERROR_STATUS_TYPE_NONE, 0, (17 * 4));
  ...
  assert_command_status_and_output(
      ...
      true, 5, ERROR_STATUS_TYPE_NONE, 0, 17);
  ...
  assert_command_status_and_output(
      ...
      "cgp " EMPTY_CGP,
      false, 60, ERROR_STATUS_TYPE_NONE, 0, 5 + 27 + 20);
  ...
  for (int i = 0; i < 3; i++) {
    ...
    assert_command_status_and_output(command_vars, "position cgp " CATALAN_CGP,
                                     false, 5, ERROR_STATUS_TYPE_NONE, 0, 0);
    assert_command_status_and_output(command_vars,
                                     "go sim plies 2 threads 10 numplays 15 i "
    ...
    assert_command_status_and_output(
        ...
        false, 60, ERROR_STATUS_TYPE_NONE, 0, 5 + 33 + 20);
