...
void take_set(LeaveMap * leave_map, Rack * rack, LetterDistribution * letter_distribution, uint64_t letter, int expected_take_index, float value) {
    take_letter_and_update_current_index(leave_map, rack, human_readable_letter_to_machine_letter(letter_distribution, letter));
...
void take_set_add(LeaveMap * leave_map, Rack * rack, LetterDistribution * letter_distribution, uint64_t letter, int expected_take_index, int expected_add_index, float value, int set) {
    take_letter_and_update_current_index(leave_map, rack, human_readable_letter_to_machine_letter(letter_distribution, letter));
    assert(leave_map->current_index == expected_take_index);
    if (set) {
        set_current_value(leave_map, value);
    ...
    add_letter_and_update_current_index(leave_map, rack, human_readable_letter_to_machine_letter(letter_distribution, letter));
...
void test_leave_map(SuperConfig * superconfig) {
    ...
    add_letter_and_update_current_index(leave_map, rack, human_readable_letter_to_machine_letter(letter_distribution, 'D'));
    add_letter_and_update_current_index(leave_map, rack, human_readable_letter_to_machine_letter(letter_distribution, 'I'));
    add_letter_and_update_current_index(leave_map, rack, human_readable_letter_to_machine_letter(letter_distribution, 'U'));
