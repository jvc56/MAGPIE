...
//   assert(get_number_of_anchors(anchor_list) == 1);
//   assert(
//       within_epsilon(get_anchor_highest_possible_equity(anchor_list, 0),
//       18));
...
//       10));
//   // EKE
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 1),
//   9));
//   // KAEE
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 2),
//   8));
//   // EE and E(A)
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 3),
//   5));
//   // EE and E(A)
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 4),
//   5));
//   // EEE
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 5),
//   3));
//   // The rest are prevented by invalid cross sets
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 6),
//   0)); assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list,
//   7), 0));
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 8),
//   0));
...
//   // KA, aE, AE
//   assert(
//       within_epsilon(get_anchor_highest_possible_equity(anchor_list, 1),
//       10));
//   // KAe, Ee
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 2),
//   8));
...
//   3));
//   // Ae, eE
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 7),
//   3));
//   // E(A)a
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 8),
//   2));
...
//   // J(A) vertically
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 3),
//   9)); assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list,
//   4), 0));
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 5),
//   0)); assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list,
//   6), 0));
...
//   assert(
//       within_epsilon(get_anchor_highest_possible_equity(anchor_list, 2),
//       25));
//   // FAA is in cross set, so JAA and JF are used to score.
//   assert(
//       within_epsilon(get_anchor_highest_possible_equity(anchor_list, 3),
//       22));
//   // AAJF
//   assert(
//       within_epsilon(get_anchor_highest_possible_equity(anchor_list, 4),
//       14));
//   // AJF
//   assert(
//       within_epsilon(get_anchor_highest_possible_equity(anchor_list, 5),
//       13));
...
//   // Making KAU (allowed by F in rack cross set) and JUF, doubling the F and
//   J. load_and_generate(game, gen, player, KA_OPENING_CGP, "JFU"); assert(
//       within_epsilon(get_anchor_highest_possible_equity(anchor_list, 0),
//       32));
...
//   // A(OW) vertically
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 2),
//   6)); assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list,
//   3), 6));
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 4),
//   6)); assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list,
//   5), 6));
...
//   // AD(A)
//   assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list, 6),
//   5)); assert(within_epsilon(get_anchor_highest_possible_equity(anchor_list,
//   7), 5));
...
//   assert(within_epsilon(best_leaves[0], klv_get_leave_value(klv,
//   leave_rack)));

//   set_rack_to_string(ld, leave_rack, "S");
//   assert(within_epsilon(best_leaves[1], klv_get_leave_value(klv,
//   leave_rack)));

//   set_rack_to_string(ld, leave_rack, "ES");
//   assert(within_epsilon(best_leaves[2], klv_get_leave_value(klv,
//   leave_rack)));

//   set_rack_to_string(ld, leave_rack, "ERS");
//   assert(within_epsilon(best_leaves[3], klv_get_leave_value(klv,
//   leave_rack)));

//   set_rack_to_string(ld, leave_rack, "EQSU");
//   assert(within_epsilon(best_leaves[4], klv_get_leave_value(klv,
//   leave_rack)));

//   set_rack_to_string(ld, leave_rack, "EQRSU");
//   assert(within_epsilon(best_leaves[5], klv_get_leave_value(klv,
//   leave_rack)));

//   set_rack_to_string(ld, leave_rack, "EQRSUV");
//   assert(within_epsilon(best_leaves[6], klv_get_leave_value(klv,
//   leave_rack)));
