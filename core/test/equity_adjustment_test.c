...
void test_macondo_endgame_equity_adjustments(SuperConfig * superconfig) {
    ...
    assert(within_epsilon_double(move0->equity, 12));
    ...
    assert(within_epsilon_double(move1->equity, 9));
    ...
    assert(within_epsilon_double(move2->equity, 1));
    ...
    assert(within_epsilon_double(move3->equity, 0));
    ...
    assert(within_epsilon_double(move4->equity, -1));
    ...
    assert(within_epsilon_double(move5->equity, -2));
