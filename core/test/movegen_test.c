...
void macondo_tests(SuperConfig * superconfig) {
    ...
    game->gen->current_row_index = 4;
    uint8_t ml = human_readable_letter_to_machine_letter(game->gen->letter_distribution, 'I');
    ...
    write_user_visible_move_to_end_of_buffer(test_string, game->gen->board, game->gen->move_list->moves[0], game->gen->letter_distribution);
    ...
    write_user_visible_move_to_end_of_buffer(test_string, game->gen->board, test_row_gen_sorted_move_list->moves[0], game->gen->letter_distribution);
    assert(!strcmp(test_string, "5B AIR(GLOWS) 12"));
    reset_string(test_string);
    write_user_visible_move_to_end_of_buffer(test_string, game->gen->board, test_row_gen_sorted_move_list->moves[1], game->gen->letter_distribution);
    ...
    write_user_visible_move_to_end_of_buffer(test_string, game->gen->board, test_gen_all_moves_with_blanks_sorted_move_list->moves[0], game->gen->letter_distribution);
    assert(!strcmp(test_string, "14B hEaDW(OR)DS 106"));
    reset_string(test_string);

    write_user_visible_move_to_end_of_buffer(test_string, game->gen->board, test_gen_all_moves_with_blanks_sorted_move_list->moves[1], game->gen->letter_distribution);
    ...
    write_user_visible_move_to_end_of_buffer(test_string, game->gen->board, test_giant_twenty_seven_timer_sorted_move_list->moves[0], game->gen->letter_distribution);
