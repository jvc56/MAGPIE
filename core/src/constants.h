...
#define INFERENCE_STATUS_BAG_EMPTY 2
#define INFERENCE_STATUS_RACKS_NOT_EMPTY 3
#define INFERENCE_STATUS_NOTHING_TO_INFER 4
#define INFERENCE_STATUS_NEGATIVE_TILES_REMAINING 5
