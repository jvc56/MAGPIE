...
#define RACK_ARRAY_SIZE MAX_ALPHABET_SIZE + 1
#define MACHINE_LETTER_MAX_VALUE 255
#define ALPHABET_EMPTY_SQUARE_MARKER MAX_ALPHABET_SIZE + 1
#define PLAYED_THROUGH_MARKER MAX_ALPHABET_SIZE + 2
#define BOARD_DIM 15
...
#define BLANK_MACHINE_LETTER MAX_ALPHABET_SIZE
#define SEPARATION_MACHINE_LETTER MAX_ALPHABET_SIZE
...
#define DEFAULT_MOVE_LIST_CAPACITY 100000
