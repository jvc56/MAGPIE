...
void print_ucgi_autoplay_results(const AutoplayResults *autoplay_results,
  ...
  char *results_string = get_formatted_string(
      ...
      autoplay_results_get_p1_firsts(autoplay_results), get_mean(autoplay_results_get_p1_score(autoplay_results)),
      get_stdev(autoplay_results_get_p1_score(autoplay_results)),
