...
void print_ucgi_autoplay_results(const AutoplayResults *autoplay_results,
  ...
  char *results_string = get_formatted_string(
      ...
      autoplay_results_get_games(autoplay_results),
      autoplay_results_get_p1_wins(autoplay_results),
      autoplay_results_get_p1_losses(autoplay_results),
      autoplay_results_get_p1_ties(autoplay_results),
      autoplay_results_get_p1_firsts(autoplay_results),
