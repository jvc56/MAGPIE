...
#if 0 // Lightweight EndgamePlyCtx solver from nested-sim branch — disabled
      // pending integration with the new EndgameCtx/EndgameCtxWorker API.
...
#endif // 0  (disabled EndgamePlyCtx block)
