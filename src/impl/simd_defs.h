...
#else
// Fallback for non-GCC/Clang compilers (though the project seems to use GCC/Clang flags)
// In a real scenario, we might define a struct or use other intrinsics.
// For now, we assume GCC/Clang extensions are available as per Makefile.
