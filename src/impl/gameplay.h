...
// For exchange inference: uses best_leaves[target_leave_size] for cutoff.
// Returns true if the rack should be pruned (threshold exceeded and top move
// is not a matching exchange).
