...
typedef enum {
  ...
  INFERENCE_STATUS_EXCHANGE_MALFORMED_PLAYER_INDEX,
  INFERENCE_STATUS_EXCHANGE_MALFORMED_RACK,
  INFERENCE_STATUS_EXCHANGE_MALFORMED_SCORE,
  INFERENCE_STATUS_EXCHANGE_MALFORMED_EXCHANGED,
