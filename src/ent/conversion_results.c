...
ConversionResults *conversion_results_create() {
    ConversionResults *conversion_results = malloc_or_die(sizeof(ConversionResults));
...
int conversion_results_get_number_of_strings(const ConversionResults *conversion_results) {
    return conversion_results->number_of_strings;
}

int conversion_results_get_number_of_nodes(const ConversionResults *conversion_results) {
    return conversion_results->number_of_nodes;
}

void conversion_results_set_number_of_strings(ConversionResults *conversion_results,
                                              int number_of_strings) {
    conversion_results->number_of_strings = number_of_strings;
}

void conversion_results_set_number_of_nodes(ConversionResults *conversion_results,
                                            int number_of_nodes) {
