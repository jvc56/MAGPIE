...
typedef enum {
  ...
  ERROR_STATUS_INFERENCE_TILES_NOT_IN_BAG,
  ...
  ERROR_STATUS_GCG_PARSE_PLAYER_RACK_NOT_EMPTY_AT_GAME_END,
  ERROR_STATUS_GCG_PARSE_PLAYER_RACK_EMPTY_AT_PASS_OUT,
  ERROR_STATUS_GCG_PARSE_OPP_RACK_EMPTY_AT_GAME_END,
  ERROR_STATUS_GCG_PARSE_INVALID_PASS_OUT,
