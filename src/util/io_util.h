...
typedef enum {
  ...
  ERROR_STATUS_CONFIG_LOAD_MOVE_COORDS_OUT_OF_BOUNDS,
  ...
  ERROR_STATUS_PAT_GEN_UNSHARED_DATA,
  // Inference errors
  ...
  ERROR_STATUS_INFERENCE_EMPTY_GAME_HISTORY,
  // Autoplay errors
  ...
  ERROR_STATUS_GCG_PARSE_RACK_TOO_MANY_LETTERS,
  ...
  ERROR_STATUS_GCG_PARSE_GAME_REDUNDANT_END_RACK_PENALTY,
  ERROR_STATUS_GCG_PARSE_GAME_REDUNDANT_TIME_PENALTY,
  // Game history navigation errors
  ...
  ERROR_STATUS_MOVE_VALIDATION_EMPTY_TILES_PLAYED,
  ...
  // WIT errors
  ERROR_STATUS_WIT_KWG_MISMATCH,
  // PAT errors
  ERROR_STATUS_PAT_INVALID_HEADER,
  ERROR_STATUS_PAT_UNSUPPORTED_VERSION,
  ERROR_STATUS_PAT_INVALID_ROW,
  ERROR_STATUS_PAT_POSITIVE_WEIGHT,
  ERROR_STATUS_PAT_WRONG_NUMBER_OF_ROWS,
  ERROR_STATUS_PAT_INVALID_CLASSES_ARG,
  // KLV errors
  ...
  ERROR_STATUS_INVALID_GCG_URL,
  ERROR_STATUS_INVALID_WOOGLES_GCG_RESPONSE,
  ...
  ERROR_STATUS_PEG_EMPTY_NO_MOVES,
  // Commit errors
  ...
  ERROR_STATUS_CHALLENGE_NO_PREVIOUS_TILE_PLACEMENT_MOVE,
