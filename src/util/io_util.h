...
typedef enum {
  ...
  ERROR_STATUS_TWD_GEN_UNSHARED_DATA,
  // Inference errors
  ...
  // TWS defense errors
  ERROR_STATUS_TWD_INVALID_HEADER,
  ERROR_STATUS_TWD_INVALID_ROW,
  ERROR_STATUS_TWD_POSITIVE_WEIGHT,
  ERROR_STATUS_TWD_WRONG_NUMBER_OF_ROWS,
  // KLV errors
