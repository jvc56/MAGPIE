magpie_pat_v5
# TWL98_release: PAT for TWL98 by the incumbent-preserving selection
...
#   0,506.054700,505.911242,512.732895,TWL98_release_adapt_gen_1_shrink0
#   1,506.070482,505.791777,511.841724,TWL98_release_adapt_gen_1_shrink1
#   10,506.186355,505.595815,508.862525,TWL98_release_adapt_gen_1_shrink10
#   100,506.533990,505.710617,506.281445,TWL98_release_adapt_gen_1_shrink100
#   1000,506.975416,506.029404,506.050292,TWL98_release_adapt_gen_1_shrink1000
#   10000,507.424637,506.378174,506.378595,TWL98_release_adapt_gen_1_shrink10000
#   100000,507.569909,506.542085,506.543607,TWL98_release_adapt_gen_1_shrink100000
#   inf,-,506.542085,-,TWL98_release_adapt_gen_1_shrinkinf
#   Installed: the loaded weights (inf); select among the candidates by whole-game play.
# Screening vs the incumbent on TWL98, dev seed 778001410, 500000 mirrored pairs:
#   pat_dls_champion_v5: mean 0.0108, SE 0.0676, 95% CI [-0.1217, 0.1432] (500000 pairs)
#   TWL98_release_s1_v4: mean -0.5401, SE 0.1018, 95% CI [-0.7397, -0.3405] (500000 pairs)
#   TWL98_release_s2_v4: mean -0.5849, SE 0.1039, 95% CI [-0.7885, -0.3814] (500000 pairs)
#   TWL98_release_s3_v4: mean -0.7544, SE 0.1079, 95% CI [-0.9659, -0.5429] (500000 pairs)
#   TWL98_release_adapt_gen_1_shrink10: mean -0.4951, SE 0.0972, 95% CI [-0.6855, -0.3047] (500000 pairs)
#   TWL98_release_adapt_gen_1_shrink100: mean -0.2709, SE 0.0896, 95% CI [-0.4465, -0.0954] (500000 pairs)
#   TWL98_release_adapt_gen_1_shrink1000: mean 0.0925, SE 0.0680, 95% CI [-0.0407, 0.2258] (500000 pairs)
# Challenger: TWL98_release_adapt_gen_1_shrink1000 as is.
# Confirmation vs the incumbent, untouched seed 778001415, 1000000 pairs: mean -0.1010, SE 0.0482, 95% CI [-0.1955, -0.0065] (1000000 pairs)
# Decision: incumbent retained: challenger TWL98_release_adapt_gen_1_shrink1000 did not confirm.
# Validation vs no PAT on TWL98, seed 778001417, 500000 pairs: mean 3.2559, SE 0.1321, 95% CI [2.9970, 3.5149] (500000 pairs)
