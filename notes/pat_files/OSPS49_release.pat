magpie_pat_v5
# OSPS49_release: PAT for OSPS49 by the incumbent-preserving selection
# (test/pat_select_champion.sh, codex/pat-setup-value, 2026-09-15).
# Incumbent: CSW24_v5 (sha256 832dd6855f021e96). Runtime tables: -wmp false.
#   shrink_lambda,fit_mse,validation_mse_refit_intercept,validation_mse_fit_intercept,file
#   0,561.258646,561.788853,570.996535,OSPS49_release_adapt_gen_1_shrink0
#   1,561.286862,561.598392,568.960393,OSPS49_release_adapt_gen_1_shrink1
#   10,561.416819,561.246195,564.754423,OSPS49_release_adapt_gen_1_shrink10
#   100,561.718154,561.267090,561.981053,OSPS49_release_adapt_gen_1_shrink100
#   1000,562.322187,561.671426,561.736118,OSPS49_release_adapt_gen_1_shrink1000
#   10000,563.441341,562.626320,562.628296,OSPS49_release_adapt_gen_1_shrink10000
#   100000,563.900314,563.110319,563.111744,OSPS49_release_adapt_gen_1_shrink100000
#   inf,-,563.110319,-,OSPS49_release_adapt_gen_1_shrinkinf
#   Installed: the loaded weights (inf); select among the candidates by whole-game play.
# Screening vs the incumbent on OSPS49, dev seed 778006660, 500000 mirrored pairs:
#   pat_dls_champion_v5: mean 0.0493, SE 0.0732, 95% CI [-0.0942, 0.1928] (500000 pairs)
#   OSPS49_release_s1_v4: mean -0.9426, SE 0.1195, 95% CI [-1.1768, -0.7084] (500000 pairs)
#   OSPS49_release_s2_v4: mean -0.6718, SE 0.1163, 95% CI [-0.8998, -0.4437] (500000 pairs)
#   OSPS49_release_s3_v4: mean -0.4876, SE 0.1155, 95% CI [-0.7139, -0.2613] (500000 pairs)
#   OSPS49_release_adapt_gen_1_shrink10: mean -0.5045, SE 0.1095, 95% CI [-0.7190, -0.2899] (500000 pairs)
#   OSPS49_release_adapt_gen_1_shrink100: mean -0.5499, SE 0.1088, 95% CI [-0.7632, -0.3367] (500000 pairs)
#   OSPS49_release_adapt_gen_1_shrink1000: mean -0.2451, SE 0.0904, 95% CI [-0.4222, -0.0679] (500000 pairs)
# Challenger: pat_dls_champion_v5 as is.
# Confirmation vs the incumbent, untouched seed 778006665, 1000000 pairs: mean -0.0089, SE 0.0517, 95% CI [-0.1103, 0.0924] (1000000 pairs)
# Decision: incumbent retained: challenger pat_dls_champion_v5 did not confirm.
# Validation vs no PAT on OSPS49, seed 778006667, 500000 pairs: mean 2.4799, SE 0.1371, 95% CI [2.2112, 2.7486] (500000 pairs)
