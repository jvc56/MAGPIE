magpie_pat_v5
# OSW4_release: PAT for OSW4 (leaves OSW4_zeroed_gen_6) by the incumbent-preserving selection
...
#   0,511.364833,512.593696,517.900415,OSW4_release_adapt_gen_1_shrink0
#   1,511.377659,512.523295,517.028657,OSW4_release_adapt_gen_1_shrink1
#   10,511.491707,512.457648,514.812751,OSW4_release_adapt_gen_1_shrink10
#   100,511.838301,512.627751,513.503338,OSW4_release_adapt_gen_1_shrink100
#   1000,512.250265,512.851649,512.911599,OSW4_release_adapt_gen_1_shrink1000
#   10000,512.643625,513.102135,513.102157,OSW4_release_adapt_gen_1_shrink10000
#   100000,512.744454,513.161492,513.162146,OSW4_release_adapt_gen_1_shrink100000
#   inf,-,513.161492,-,OSW4_release_adapt_gen_1_shrinkinf
#   Installed: the loaded weights (inf); select among the candidates by whole-game play.
# Screening vs the incumbent on OSW4, dev seed 778009500, 500000 mirrored pairs:
#   pat_dls_champion_v5: mean -0.1545, SE 0.0675, 95% CI [-0.2868, -0.0222] (500000 pairs)
#   OSW4_release_s1_v4: mean -0.2043, SE 0.0905, 95% CI [-0.3818, -0.0268] (500000 pairs)
#   OSW4_release_s2_v4: mean -0.1689, SE 0.0862, 95% CI [-0.3377, -0.0000] (500000 pairs)
#   OSW4_release_s3_v4: mean -0.2321, SE 0.0943, 95% CI [-0.4169, -0.0473] (500000 pairs)
#   OSW4_release_adapt_gen_1_shrink10: mean -0.0443, SE 0.0898, 95% CI [-0.2203, 0.1316] (500000 pairs)
#   OSW4_release_adapt_gen_1_shrink100: mean 0.0405, SE 0.0808, 95% CI [-0.1180, 0.1989] (500000 pairs)
#   OSW4_release_adapt_gen_1_shrink1000: mean -0.0609, SE 0.0602, 95% CI [-0.1788, 0.0571] (500000 pairs)
# Challenger: OSW4_release_adapt_gen_1_shrink100 as is.
# Confirmation vs the incumbent, untouched seed 778009505, 1000000 pairs: mean 0.0254, SE 0.0573, 95% CI [-0.0870, 0.1378] (1000000 pairs)
# Decision: incumbent retained: challenger OSW4_release_adapt_gen_1_shrink100 did not confirm.
# Validation vs no PAT on OSW4, seed 778009507, 500000 pairs: mean 3.0069, SE 0.1319, 95% CI [2.7484, 3.2654] (500000 pairs)
