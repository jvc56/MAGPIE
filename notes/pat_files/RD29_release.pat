magpie_pat_v5
# RD29_release: PAT for RD29 by the incumbent-preserving selection
...
#   0,624.073035,625.802058,640.759626,RD29_release_adapt_gen_1_shrink0
#   1,624.130953,625.456179,638.304029,RD29_release_adapt_gen_1_shrink1
#   10,624.330076,624.940050,632.100780,RD29_release_adapt_gen_1_shrink10
#   100,624.862761,624.929522,626.678189,RD29_release_adapt_gen_1_shrink100
#   1000,626.146953,625.862117,626.009246,RD29_release_adapt_gen_1_shrink1000
#   10000,629.118602,628.738501,628.741517,RD29_release_adapt_gen_1_shrink10000
#   100000,630.760965,630.439160,630.441153,RD29_release_adapt_gen_1_shrink100000
#   inf,-,630.570650,-,RD29_release_adapt_gen_1_shrinkinf
#   Installed: the loaded weights (inf); select among the candidates by whole-game play.
# Screening vs the incumbent on RD29, dev seed 778004780, 500000 mirrored pairs:
#   pat_dls_champion_v5: mean 0.0734, SE 0.0744, 95% CI [-0.0724, 0.2193] (500000 pairs)
#   RD29_release_s1_v4: mean -1.1715, SE 0.1378, 95% CI [-1.4416, -0.9014] (500000 pairs)
#   RD29_release_s2_v4: mean -1.0212, SE 0.1372, 95% CI [-1.2901, -0.7522] (500000 pairs)
#   RD29_release_s3_v4: mean -1.0441, SE 0.1392, 95% CI [-1.3170, -0.7713] (500000 pairs)
#   RD29_release_adapt_gen_1_shrink10: mean -0.4898, SE 0.1253, 95% CI [-0.7353, -0.2443] (500000 pairs)
#   RD29_release_adapt_gen_1_shrink100: mean -0.3138, SE 0.1240, 95% CI [-0.5568, -0.0708] (500000 pairs)
#   RD29_release_adapt_gen_1_shrink1000: mean -0.2527, SE 0.1115, 95% CI [-0.4713, -0.0341] (500000 pairs)
# Challenger: pat_dls_champion_v5 as is.
# Confirmation vs the incumbent, untouched seed 778004785, 1000000 pairs: mean 0.0866, SE 0.0528, 95% CI [-0.0168, 0.1900] (1000000 pairs)
# Decision: incumbent retained: challenger pat_dls_champion_v5 did not confirm.
# Validation vs no PAT on RD29, seed 778004787, 500000 pairs: mean 2.8100, SE 0.1472, 95% CI [2.5214, 3.0986] (500000 pairs)
