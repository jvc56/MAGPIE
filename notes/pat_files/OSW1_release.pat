magpie_pat_v5
# OSW1_release: PAT for OSW1 (leaves OSW1_zeroed_gen_6) by the incumbent-preserving selection
...
#   0,509.622835,510.080643,515.560465,OSW1_release_adapt_gen_1_shrink0
#   1,509.634537,509.994465,514.515180,OSW1_release_adapt_gen_1_shrink1
#   10,509.741117,509.915768,512.347730,OSW1_release_adapt_gen_1_shrink10
#   100,510.076808,510.094773,510.841142,OSW1_release_adapt_gen_1_shrink100
#   1000,510.503955,510.339553,510.380462,OSW1_release_adapt_gen_1_shrink1000
#   10000,510.913204,510.636084,510.636567,OSW1_release_adapt_gen_1_shrink10000
#   100000,511.017225,510.715932,510.717611,OSW1_release_adapt_gen_1_shrink100000
#   inf,-,510.715932,-,OSW1_release_adapt_gen_1_shrinkinf
#   Installed: the loaded weights (inf); select among the candidates by whole-game play.
# Screening vs the incumbent on OSW1, dev seed 778000750, 500000 mirrored pairs:
#   pat_dls_champion_v5: mean -0.0002, SE 0.0684, 95% CI [-0.1342, 0.1338] (500000 pairs)
#   OSW1_release_s1_v4: mean -0.2727, SE 0.0876, 95% CI [-0.4444, -0.1010] (500000 pairs)
#   OSW1_release_s2_v4: mean -0.3248, SE 0.0962, 95% CI [-0.5134, -0.1362] (500000 pairs)
#   OSW1_release_s3_v4: mean -0.1786, SE 0.0932, 95% CI [-0.3613, 0.0042] (500000 pairs)
#   OSW1_release_adapt_gen_1_shrink10: mean -0.2297, SE 0.0923, 95% CI [-0.4106, -0.0488] (500000 pairs)
#   OSW1_release_adapt_gen_1_shrink100: mean 0.0994, SE 0.0848, 95% CI [-0.0668, 0.2657] (500000 pairs)
#   OSW1_release_adapt_gen_1_shrink1000: mean 0.1598, SE 0.0652, 95% CI [0.0320, 0.2875] (500000 pairs)
# Challenger: OSW1_release_adapt_gen_1_shrink1000 as is.
# Confirmation vs the incumbent, untouched seed 778000755, 1000000 pairs: mean -0.0110, SE 0.0460, 95% CI [-0.1013, 0.0792] (1000000 pairs)
# Decision: incumbent retained: challenger OSW1_release_adapt_gen_1_shrink1000 did not confirm.
# Validation vs no PAT on OSW1, seed 778000757, 500000 pairs: mean 2.8444, SE 0.1324, 95% CI [2.5849, 3.1038] (500000 pairs)
